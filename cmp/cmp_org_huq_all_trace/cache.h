...
typedef struct 
{
    int type;                   //the message type, contain wirte and read. 1 represent write, 0 represent read.
    int initiator;              //the message initiator, 1 represent initiator is main core, 0 represent initiator is slave core.
    md_addr_t srcaddr;          //the message initiator address.
    md_addr_t dstaddr;          //the message destination address.
    int data;                   //the read data.
    int deal;                   //represent the message deal success or not. 
}dma_message;
/*lxz edit*/
...
#define MTA_RMA_READ_REPLY 197
#define MTA_DMA_READ_REPLY 198
